...
if __name__ == '__main__':
    YashLibrary=Library(["Python","C++","Java","DSA","SQL"])
    Student=Student()
    while(True):
        ...
        if a==1:
            YashLibrary.displayAvailbleBooks()
        elif a==2:
            YashLibrary.borrowBook(Student.requestBook())
        elif a==3:
            YashLibrary.returnBook(Student.returnBook())
        elif a==4:
